...
export const FeatureLayout1: Block = {
  slug: "featureLayout1",
  interfaceName: "FeatureLayout1",
  imageURL:
    "https://minio.thespecialcharacter.com/payload-website-templates/thumbnail_featurelayout1.png",
